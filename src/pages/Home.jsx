...
const Home = () => {
  ...
  function refreshPalette() {
    const outer_lower_colour = generateRandomColor();
    const outer_upper_colour = generateRandomColor();
    const inner_lower_colour = generateRandomColor();
    const inner_upper_colour = generateRandomColor();
    const background_colour = generateRandomColor();
    setBackgroundPathColor(background_colour);
    setLowerInnerQuadColor(inner_lower_colour);
    setUpperInnerQuadColor(inner_upper_colour);
    setUpperOuterQuadColor(outer_upper_colour);
    setLowerOuterQuadColor(outer_lower_colour);
  }
